...
public class AclClassDao extends DAOImpl<AclClassRecord, database.tables.pojos.AclClass, Long> {

    /**
     * Create a new AclClassDao without any configuration
     */
    public AclClassDao() {
        super(AclClass.ACL_CLASS, database.tables.pojos.AclClass.class);
    }
    ...
    public AclClassDao(Configuration configuration) {
        super(AclClass.ACL_CLASS, database.tables.pojos.AclClass.class, configuration);
    }

    @Override
    public Long getId(database.tables.pojos.AclClass object) {
        return object.getId();
    }
     ...
     */
    public List<database.tables.pojos.AclClass> fetchRangeOfId(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<database.tables.pojos.AclClass> fetchById(Long... values) {
     ...
     */
    public database.tables.pojos.AclClass fetchOneById(Long value) {
     ...
     */
    public List<database.tables.pojos.AclClass> fetchRangeOfClass(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<database.tables.pojos.AclClass> fetchByClass(String... values) {
     ...
     */
    public database.tables.pojos.AclClass fetchOneByClass(String value) {
