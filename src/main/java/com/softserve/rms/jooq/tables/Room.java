...
public class Room extends TableImpl<RoomRecord> {
    ...
    private static final long serialVersionUID = 705921394;
     ...
     */
    public final TableField<RoomRecord, Long> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('room_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>public.room.name</code>.
     */
    public final TableField<RoomRecord, String> NAME = createField(DSL.name("name"), org.jooq.impl.SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>public.room.description</code>.
     */
    public final TableField<RoomRecord, String> DESCRIPTION = createField(DSL.name("description"), org.jooq.impl.SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>public.room.number</code>.
     */
    public final TableField<RoomRecord, Integer> NUMBER = createField(DSL.name("number"), org.jooq.impl.SQLDataType.INTEGER, this, "");

    /**
     * The column <code>public.room.testint</code>.
     */
    public final TableField<RoomRecord, Integer> TESTINT = createField(DSL.name("testint"), org.jooq.impl.SQLDataType.INTEGER, this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.ID);
    }
    ...
    public List<UniqueKey<RoomRecord>> getKeys() {
        return Arrays.<UniqueKey<RoomRecord>>asList(Keys.ID);
    }
