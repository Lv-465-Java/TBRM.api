...
public class AclObjectIdentityRecord extends UpdatableRecordImpl<AclObjectIdentityRecord> implements Record6<Long, Long, String, Long, Long, Boolean> {

    private static final long serialVersionUID = 190118235;
    ...
    @Override
    public AclObjectIdentityRecord value3(String value) {
    ...
    @Override
    public AclObjectIdentityRecord values(Long value1, Long value2, String value3, Long value4, Long value5, Boolean value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AclObjectIdentityRecord(Long id, Long objectIdClass, String objectIdIdentity, Long parentObject, Long ownerSid, Boolean entriesInheriting) {
        super(AclObjectIdentity.ACL_OBJECT_IDENTITY);
