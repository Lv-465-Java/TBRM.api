...
public class AclObjectIdentityDao extends DAOImpl<AclObjectIdentityRecord, com.softserve.rms.jooq.tables.pojos.AclObjectIdentity, Long> {

    /**
     * Create a new AclObjectIdentityDao without any configuration
     */
    public AclObjectIdentityDao() {
        super(AclObjectIdentity.ACL_OBJECT_IDENTITY, com.softserve.rms.jooq.tables.pojos.AclObjectIdentity.class);
    }
    ...
    public AclObjectIdentityDao(Configuration configuration) {
        super(AclObjectIdentity.ACL_OBJECT_IDENTITY, com.softserve.rms.jooq.tables.pojos.AclObjectIdentity.class, configuration);
    }

    @Override
    public Long getId(com.softserve.rms.jooq.tables.pojos.AclObjectIdentity object) {
        return object.getId();
    }
     ...
     */
    public List<com.softserve.rms.jooq.tables.pojos.AclObjectIdentity> fetchRangeOfId(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<com.softserve.rms.jooq.tables.pojos.AclObjectIdentity> fetchById(Long... values) {
     ...
     */
    public com.softserve.rms.jooq.tables.pojos.AclObjectIdentity fetchOneById(Long value) {
     ...
     */
    public List<com.softserve.rms.jooq.tables.pojos.AclObjectIdentity> fetchRangeOfObjectIdClass(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<com.softserve.rms.jooq.tables.pojos.AclObjectIdentity> fetchByObjectIdClass(Long... values) {
     ...
     */
    public List<com.softserve.rms.jooq.tables.pojos.AclObjectIdentity> fetchRangeOfObjectIdIdentity(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.softserve.rms.jooq.tables.pojos.AclObjectIdentity> fetchByObjectIdIdentity(String... values) {
     ...
     */
    public List<com.softserve.rms.jooq.tables.pojos.AclObjectIdentity> fetchRangeOfParentObject(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<com.softserve.rms.jooq.tables.pojos.AclObjectIdentity> fetchByParentObject(Long... values) {
     ...
     */
    public List<com.softserve.rms.jooq.tables.pojos.AclObjectIdentity> fetchRangeOfOwnerSid(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<com.softserve.rms.jooq.tables.pojos.AclObjectIdentity> fetchByOwnerSid(Long... values) {
     ...
     */
    public List<com.softserve.rms.jooq.tables.pojos.AclObjectIdentity> fetchRangeOfEntriesInheriting(Boolean lowerInclusive, Boolean upperInclusive) {
     ...
     */
    public List<com.softserve.rms.jooq.tables.pojos.AclObjectIdentity> fetchByEntriesInheriting(Boolean... values) {
