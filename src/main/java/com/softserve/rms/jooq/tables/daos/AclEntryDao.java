...
public class AclEntryDao extends DAOImpl<AclEntryRecord, com.softserve.rms.jooq.tables.pojos.AclEntry, Long> {

    /**
     * Create a new AclEntryDao without any configuration
     */
    public AclEntryDao() {
        super(AclEntry.ACL_ENTRY, com.softserve.rms.jooq.tables.pojos.AclEntry.class);
    }
    ...
    public AclEntryDao(Configuration configuration) {
        super(AclEntry.ACL_ENTRY, com.softserve.rms.jooq.tables.pojos.AclEntry.class, configuration);
    }

    @Override
    public Long getId(com.softserve.rms.jooq.tables.pojos.AclEntry object) {
        return object.getId();
    }
     ...
     */
    public List<com.softserve.rms.jooq.tables.pojos.AclEntry> fetchRangeOfId(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<com.softserve.rms.jooq.tables.pojos.AclEntry> fetchById(Long... values) {
     ...
     */
    public com.softserve.rms.jooq.tables.pojos.AclEntry fetchOneById(Long value) {
     ...
     */
    public List<com.softserve.rms.jooq.tables.pojos.AclEntry> fetchRangeOfAclObjectIdentity(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<com.softserve.rms.jooq.tables.pojos.AclEntry> fetchByAclObjectIdentity(Long... values) {
     ...
     */
    public List<com.softserve.rms.jooq.tables.pojos.AclEntry> fetchRangeOfAceOrder(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.softserve.rms.jooq.tables.pojos.AclEntry> fetchByAceOrder(Integer... values) {
     ...
     */
    public List<com.softserve.rms.jooq.tables.pojos.AclEntry> fetchRangeOfSid(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<com.softserve.rms.jooq.tables.pojos.AclEntry> fetchBySid(Long... values) {
     ...
     */
    public List<com.softserve.rms.jooq.tables.pojos.AclEntry> fetchRangeOfMask(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.softserve.rms.jooq.tables.pojos.AclEntry> fetchByMask(Integer... values) {
     ...
     */
    public List<com.softserve.rms.jooq.tables.pojos.AclEntry> fetchRangeOfGranting(Boolean lowerInclusive, Boolean upperInclusive) {
     ...
     */
    public List<com.softserve.rms.jooq.tables.pojos.AclEntry> fetchByGranting(Boolean... values) {
     ...
     */
    public List<com.softserve.rms.jooq.tables.pojos.AclEntry> fetchRangeOfAuditSuccess(Boolean lowerInclusive, Boolean upperInclusive) {
     ...
     */
    public List<com.softserve.rms.jooq.tables.pojos.AclEntry> fetchByAuditSuccess(Boolean... values) {
     ...
     */
    public List<com.softserve.rms.jooq.tables.pojos.AclEntry> fetchRangeOfAuditFailure(Boolean lowerInclusive, Boolean upperInclusive) {
     ...
     */
    public List<com.softserve.rms.jooq.tables.pojos.AclEntry> fetchByAuditFailure(Boolean... values) {
